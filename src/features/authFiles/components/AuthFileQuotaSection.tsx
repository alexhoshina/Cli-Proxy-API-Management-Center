...
const getQuotaConfig = (type: QuotaProviderType) => {
  ...
  if (type === 'copilot' || type === 'github-copilot') return COPILOT_CONFIG;
...
export function AuthFileQuotaSection(props: AuthFileQuotaSectionProps) {
  ...
  const quota = useQuotaStore((state) => {
    ...
    if (quotaType === 'copilot' || quotaType === 'github-copilot') return state.copilotQuota[file.name] as QuotaState;
  ...
  const updateQuotaState = useQuotaStore((state) => {
    ...
    if (quotaType === 'copilot' || quotaType === 'github-copilot') return state.setCopilotQuota as unknown as (updater: unknown) => void;
